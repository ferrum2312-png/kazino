...
const dict = {
  ru: {
    ...
    continue: 'Продолжить',
    minAmount: 'Минимум {n} TON',
    linkWallet: 'Привязать кошелёк',
    walletLinked: 'Кошелёк подключён',
    from: 'от',
    back: 'Назад',
    m_gifts: 'Подарками',
    m_gifts_sub: 'Появятся в инвентаре',
    m_ton: 'Toncoin',
    m_ton_sub: 'TON, USDT',
    m_stars: 'Telegram Stars',
    m_stars_sub: 'Конвертируется в TON',
    m_cryptobot: 'Crypto Bot',
    m_cryptobot_sub: 'TON, USDT',
    payStars: 'Оплатить {n} ★',
    payCrypto: 'Оплатить {n} {a}',
    paid: 'Оплачено! Баланс скоро обновится',
    payFailed: 'Оплата не удалась',
    payOpened: 'Счёт открыт. После оплаты баланс обновится',
    balanceLabel: 'Баланс',
    // cases
    casesTitle: 'Кейсы',
  ...
  en: {
    ...
    topUpTitle: 'Top up',
    continue: 'Continue',
    minAmount: 'Minimum {n} TON',
    linkWallet: 'Link wallet',
    walletLinked: 'Wallet connected',
    from: 'from',
    back: 'Back',
    m_gifts: 'With gifts',
    m_gifts_sub: 'Added to inventory',
    m_ton: 'Toncoin',
    m_ton_sub: 'TON, USDT',
    m_stars: 'Telegram Stars',
    m_stars_sub: 'Converts to TON',
    m_cryptobot: 'Crypto Bot',
    m_cryptobot_sub: 'TON, USDT',
    payStars: 'Pay {n} ★',
    payCrypto: 'Pay {n} {a}',
    paid: 'Paid! Balance will update shortly',
    payFailed: 'Payment failed',
    payOpened: 'Invoice opened. Balance updates after payment',
